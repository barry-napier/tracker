...
const PATHS = {
  ...
  // Flipped so the divider sits right of center — the panel it toggles is on
  // the right, and the unflipped glyph read as a left sidebar.
  "layout-right": (
  ...
  // Flipped like layout-right; the fill marks the open right panel.
  "layout-right-partial": (
    <g transform="translate(20 0) scale(-1 1)">
      <path
        d="M6.9987 17.0807L2.91536 17.0807V2.91406H6.9987V17.0807Z"
        fill="currentColor"
        fillOpacity="16%"
      />
      <path
