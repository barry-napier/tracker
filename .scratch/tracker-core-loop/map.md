...
- **Build slices:** the spec is sliced into vertical tracer-bullet tickets 22–42 (2026-07-18, /to-tickets; the earlier horizontal module tickets 14–20 are closed as superseded). Frontier: [28 Plan phase emits AC checks](issues/28-plan-emits-ac-checks.md) done 2026-07-18; next up [29 Gate battery at Verifying](issues/29-gate-battery.md); [End-to-end proof](issues/13-e2e-proof.md) remains the map-closing acceptance ticket, now blocked by 33, 35, 37, 38, 39, 40, 41, 42. Work slices one at a time with /implement, clearing context between tickets.
